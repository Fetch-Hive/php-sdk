...
/**
 * InvokeWorkflowResponse Class Doc Comment
 *
 * @category Class
 * @description Synchronous workflow result.
 * @package  FetchHive\Sdk\Generated
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class InvokeWorkflowResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'InvokeWorkflowResponse';
     ...
     * Sets run_id
     *
     * @param string|null $run_id Workflow run identifier.
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string|null $status Final status of the workflow run.
     *
     * @return self
     */
     ...
     * Sets output
     *
     * @param string|null $output The workflow's final output value. May contain serialised JSON; parse client-side as needed.
     *
     * @return self
     */
