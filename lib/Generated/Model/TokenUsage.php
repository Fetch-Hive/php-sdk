 ...
 */
class TokenUsage implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'TokenUsage';
     ...
     * Sets prompt_tokens
     *
     * @param int|null $prompt_tokens Number of tokens in the prompt / input.
     *
     * @return self
     */
     ...
     *
     * @param int|null $completion_tokens Number of tokens in the completion / output.
     *
     * @return self
     */
