...
/**
 * InvokeHiveAgentResponse Class Doc Comment
 *
 * @category Class
 * @description Hive Agent run accepted response.
 * @package  FetchHive\Sdk\Generated
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class InvokeHiveAgentResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'InvokeHiveAgentResponse';
     ...
     * Sets run_id
     *
     * @param string|null $run_id Identifier for the queued Hive Agent run.
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string|null $status Initial run status. Usually `pending`.
     *
     * @return self
     */
     ...
     * Sets webhook_secret
     *
     * @param string|null $webhook_secret Secret used to verify the signed callback.
     *
     * @return self
     */
