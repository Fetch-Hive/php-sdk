...
/**
 * PublicWorkspacesWorkspaceIdKnowledgeBasesKnowledgeBaseIdItemsGet200ResponseKnowledgeBaseItemsInner Class Doc Comment
 *
 * @category Class
 * @package  FetchHive\Sdk\Generated
 * @author   OpenAPI Generator team
 ...
 */
class PublicWorkspacesWorkspaceIdKnowledgeBasesKnowledgeBaseIdItemsGet200ResponseKnowledgeBaseItemsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = '_public_workspaces__workspace_id__knowledge_bases__knowledge_base_id__items_get_200_response_knowledge_base_items_inner';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('knowledge_base_id', $data ?? [], null);
        $this->setIfExists('item_type', $data ?? [], null);
        $this->setIfExists('run_status', $data ?? [], null);
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['knowledge_base_id'] === null) {
            $invalidProperties[] = "'knowledge_base_id' can't be null";
        }
        if ($this->container['item_type'] === null) {
            $invalidProperties[] = "'item_type' can't be null";
        }
        if ($this->container['run_status'] === null) {
            $invalidProperties[] = "'run_status' can't be null";
        }
     ...
     *
     * @param string $knowledge_base_id knowledge_base_id
     *
     * @return self
     */
    public function setKnowledgeBaseId($knowledge_base_id)
    {
        if (is_null($knowledge_base_id)) {
            throw new \InvalidArgumentException('non-nullable knowledge_base_id cannot be null');
        }
     ...
     * Sets run_status
     *
     * @param string $run_status run_status
     *
     * @return self
     */
    public function setRunStatus($run_status)
    {
        if (is_null($run_status)) {
            throw new \InvalidArgumentException('non-nullable run_status cannot be null');
        }
