 ...
 */
class AsyncConfig implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'AsyncConfig';
     ...
     * Sets enabled
     *
     * @param bool $enabled When `true`, the endpoint returns immediately with a `run_id` rather than waiting for the workflow to complete.
     *
     * @return self
     */
     ...
     * Sets callback_url
     *
     * @param string|null $callback_url Optional HTTPS URL that receives a POST with the workflow result when execution finishes (async mode only).
     *
     * @return self
     */
