...
/**
 * InvokeWorkflowAsyncResponse Class Doc Comment
 *
 * @category Class
 * @description Asynchronous workflow accepted response.
 * @package  FetchHive\Sdk\Generated
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class InvokeWorkflowAsyncResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'InvokeWorkflowAsyncResponse';
     ...
     * Sets run_id
     *
     * @param string|null $run_id Identifier for the queued workflow run. Use this to poll `GET /v1/workflow_runs/{id}` on the management API.
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string|null $status Always `\"queued\"` for async responses.
     *
     * @return self
     */
