...
/**
 * PublicSearchServicesCountriesGet200ResponseServicesInnerCountriesInner Class Doc Comment
 *
 * @category Class
 * @package  FetchHive\Sdk\Generated
 * @author   OpenAPI Generator team
 ...
 */
class PublicSearchServicesCountriesGet200ResponseServicesInnerCountriesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = '_public_search_services_countries_get_200_response_services_inner_countries_inner';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('alpha2', $data ?? [], null);
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['alpha2'] === null) {
            $invalidProperties[] = "'alpha2' can't be null";
        }
    ...
    {
        if (is_null($alpha2)) {
            throw new \InvalidArgumentException('non-nullable alpha2 cannot be null');
        }
        $this->container['alpha2'] = $alpha2;
