...
/**
 * HiveAgentAsyncConfig Class Doc Comment
 *
 * @category Class
 * @package  FetchHive\Sdk\Generated
 * @author   OpenAPI Generator team
 ...
 */
class HiveAgentAsyncConfig implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'HiveAgentAsyncConfig';
     ...
     * Sets enabled
     *
     * @param bool $enabled Must be `true`. Hive Agent invocation is async-only.
     *
     * @return self
     */
     ...
     * Sets callback_url
     *
     * @param string $callback_url HTTPS URL that receives the signed terminal callback.
     *
     * @return self
     */
