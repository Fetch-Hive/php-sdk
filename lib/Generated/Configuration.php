...
namespace FetchHive\Sdk\Generated;
...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://api.fetchhive.com/v1';
     ...
     * @var string
     */
    protected $userAgent = 'OpenAPI-Generator/{{VERSION}}/PHP';
    ...
    {
        $report  = 'PHP SDK (FetchHive\Sdk\Generated) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: 0.1.9' . PHP_EOL;
        $report .= '    SDK Package Version: {{VERSION}}' . PHP_EOL;
